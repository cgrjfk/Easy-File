...
class MainFacade(QMainWindow):
    def __init__(self):
        ...
        self.encryption_button = self.create_button('icon/icon.png', '文本加密')
    ...
    def create_button(self, icon_path, text):
        ...
        button.setStyleSheet("""
            QPushButton {
                background-color: ; /* 这里应该填入默认的背景颜色 */
                color: black;
    ...
    def create_main_tab(self):
        ...
        scaled_pixmap = pixmap.scaledToWidth(180, Qt.SmoothTransformation)  # 设置最大宽度为 180，等比例缩放
        ...
        image_layout.addSpacing(40)  # 增加一些距离
        ...
        layout.addLayout(image_layout)  # 添加图片与距离布局
    ...
    def initUI(self):
        ...
        self.resize(1450, 950)  # 调整窗口大小
        self.center_window()  # 居中窗口
        self.setWindowIcon(QIcon(r'icon/icon.png'))  # 确保icon.png存在于程序目录下
...
if __name__ == '__main__':
    ...
    # 创建系统托盘图标
    tray_icon = QSystemTrayIcon(QIcon("icon/icon.png"), app)
